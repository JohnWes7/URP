    ...
    SubShader
    {
        Pass
        {
            ...
            float4 frag(v2f_img i) : SV_Target
            {
                ...
                float step_value_1 = step(1.001 - _Intensity*1.001, pow(glitch.b, 2.5)); // step_value_1
                float step_value_2 = step(_BlackScreen_Slider*1.001, pow(glitch.b, 2.5)); // step_value_2
